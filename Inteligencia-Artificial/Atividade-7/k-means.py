...
data = pd.read_csv('C:/Users/isabe/OneDrive/Documentos/GitHub/ComputerScienceUFFS/Inteligencia-Artificial/Atividade-7/dados.csv')
...
modelo_ia_1 = KMeans(n_clusters=7)
...
data.to_csv('C:/Users/isabe/OneDrive/Documentos/GitHub/ComputerScienceUFFS/Inteligencia-Artificial/Atividade-7/resultado.csv', index=False)
print(data)
...
# Salva os resultados em arquivo
centros.to_csv('C:/Users/isabe/OneDrive/Documentos/GitHub/ComputerScienceUFFS/Inteligencia-Artificial/Atividade-7/grupos.csv', index=False)
print(centros)
